...
<div class="tabel table-borderless">
        <div class="row">
          <div class="col-9">
              <div class="row">
                  <div class="col-12">
          ...
          <div class="col-3">
              <form style="font-size: 14px;">
                <table class="table table-sm">
                  <tbody>
                  	<tr id="sebelas">
                      <th style="padding-left: 20px; padding-top: 15px;">SENSOR</th>
                      <th>Kondisi ON/OFF</th>
                      <th>Nilai Pengukuran</th>
                    </tr>
                    <tr id="duabelas">
                      <td style="padding-left: 20px;">Debit Air</td>
                      <td><button id="ONo"></button></td>
                      <td id="debit"></td>
                    </tr>
                    <tr id="tigabelas">
                      <td style="padding-left: 20px;">Resistiviti</td>
      ...
      function loadData() {
        ...
        for (var i in sensor){
          if (sensor[i].ip == "192.168.1.11") {
          ...
          }else if (sensor[i].ip == "192.168.1.27") {
          ...
          }else if (sensor[i].ip == "192.168.1.31") {
            var sensor31 = sensor[i].level;
            var waktusensor31 = sensor[i].waktu;
            ...
            var sensor41 = sensor[i].level;
            var waktusensor41 = sensor[i].waktu;
